...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans overflow-x-hidden relative">
      {/* Background Patterns */}
      <div className="absolute inset-0 z-[-1] opacity-20 dark:opacity-10 pointer-events-none" aria-hidden="true">
          ...
          >
            ...
            >
              <Button
                ...
                aria-label="Create a new sync room"
              >
                <Zap className="mr-2 h-5 w-5" aria-hidden="true" /> Start New Room
              </Button>

              <form onSubmit={handleJoinRoom} className="flex gap-2">
                <label htmlFor="room-id-input" className="sr-only">Enter Room ID</label>
                <input
                  id="room-id-input"
                  type="text"
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="h-14 border-2 border-foreground shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:active:shadow-[2px_2px_0px_0px_rgba(255,255,255,1)] hover:bg-accent hover:text-accent-foreground"
