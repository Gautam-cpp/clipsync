...
export default function OTPInput({openOtpdialog, setOpenOtpdialog, email}: dialogboxProps) {
    ...
    async function verifyOtp() {
        ...
        try {
            ...
            const result = await axios.post<{success: boolean, message: string}>('/api/verifyOtp', {
                email: email,
                otp: otp.join('')
            });
    ...
    return(
        <div className="fixed inset-0 backdrop-blur-sm bg-opacity-50 flex items-center justify-center z-50">
            <div className="w-full inset-ring-2 inset-ring-blue-500 max-w-md p-8 bg-white rounded-lg shadow-gray-500 shadow-2xl">
